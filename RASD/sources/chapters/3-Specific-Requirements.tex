...
\afterpage{% Makes the following pages landscape to fit the table.
    \clearpage% Flushes earlier floats.
    \begin{landscape}% The actual landscape environment.
        \centering % Center the following table.
        ...
        \end{longtable}
    \end{landscape}
    \clearpage% Clear any produced floats in order to not compromise the following text.
}
