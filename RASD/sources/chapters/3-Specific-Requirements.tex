...
% 1
\subsubsection{UCXX:Student Login }
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/UC_1.pdf}
...
% 2
\subsubsection{UCXX: Studend uploads its CV and recieves suggestions}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/UC_2.pdf}
...
% 7
\subsubsection{UCXX:Student answers questionnaire at internship completion}
...
% 9
\subsubsection{UCXX: company creates an internship announcement}
...
\begin{center}
    \begin{longtable}{|l|p{0.75\linewidth}|}
        ...
        \textbf{Flow of Events:}   & \begin{enumerate}
                                     ...
                                     \end{enumerate} \\
        \hline
        \textbf{Exit Conditions:}  & CO has successfully created an internship announcement or a partial varsion was saved.                                                             \\
        \hline
        \textbf{Exceptions:}       & S\&C generated an internal error.                                                                                                                  \\
        \hline                                                                                                                                                                          \\
    \end{longtable}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/UC_9.pdf}
...
% 11
\subsubsection{UCXX: Company creates a questionnaire for the applicants}
\label{subsubsec:Company-creates-a-questionnaire}
\begin{center}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/UC_11.pdf}
...
% 13
\subsubsection{UCXX: Company Create A Complaints}
