...
\Large\textcolor{green}{Facts of the model}\hfill\break
\textcolor{green}{\noindent\rule{\textwidth}{1pt}}
...
\par\hfill\break
\textcolor{green}{\noindent\rule{\textwidth}{1pt}}
\Large\textcolor{green}{Facts that model the evulution of the internship}\hfill\break
\textcolor{green}{\noindent\rule{\textwidth}{1pt}}
...
\par In order to visualize the final model and check that the bahaoivor is consistent with the requirements, the following predicates are used to generate instances.
