...
% Define Alloy language (custom settings for highlighting)
\lstdefinelanguage{Alloy}{
    keywords={abstract, module, open, sig, extends, fact, pred, fun, let, this, implies, some, all, no, one, lone, set,},
    keywordstyle=\color{blue}\bfseries,
    morekeywords=[2]{eventually, always, until, before, after, once,not, and, or, implies, iff, else, disj, xor, in, &},
...
\include{./chapters/2-Overall-Description.tex}

\include{./chapters/3-Specific-Requirements.tex}

\include{./chapters/4-Formal-Analysis.tex}

\include{./chapters/5-Effort-Spent.tex}

\include{./chapters/6-References.tex}
